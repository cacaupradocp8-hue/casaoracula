-- Promover institutotransfore@gmail.com para admin
UPDATE public.user_roles 
SET portal = 'admin' 
WHERE user_id = (
  SELECT id FROM auth.users WHERE email = 'institutotransfore@gmail.com'
);
...
FROM auth.users 
WHERE email = 'institutotransfore@gmail.com'
  AND NOT EXISTS (
