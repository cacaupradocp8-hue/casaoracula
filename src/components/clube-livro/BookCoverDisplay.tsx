...
export function BookCoverDisplay({ capaUrl, titulo, autor, navLinks }: BookCoverDisplayProps) {
    ...
    <>
      ...
      <Dialog open={lightbox} onOpenChange={setLightbox}>
        <DialogContent className="max-w-md p-4 bg-background/95">
          ...
          {/* Botões de navegação para páginas da Estação */}
