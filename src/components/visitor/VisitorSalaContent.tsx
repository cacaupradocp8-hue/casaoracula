...
export function VisitorSalaContent() {
  ...
  return (
    <main className="relative min-h-screen text-foreground overflow-hidden flex items-center justify-center px-6" style={{ background: 'radial-gradient(ellipse at center, #061633 0%, #03102a 45%, #020a1c 75%, #01050f 100%)' }}>
