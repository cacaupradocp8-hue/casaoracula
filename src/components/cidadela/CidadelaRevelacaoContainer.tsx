...
import { Compass, RefreshCw, Map, ArrowRight } from 'lucide-react';
...
interface CidadelaRevelacaoContainerProps {
  bussola: BussolaData;
}

export function CidadelaRevelacaoContainer({ bussola }: CidadelaRevelacaoContainerProps) {
    ...
    <div className="space-y-16 pb-20">
      ...
      <header className="text-center space-y-4 pt-8">
        ...
        <p className="text-sm md:text-base text-muted-foreground max-w-lg mx-auto italic">
          O mapa simbólico do modo como você habita a Casa Orácula.
        </p>
      </header>
