    ...
    <div className="space-y-16 max-w-5xl mx-auto py-12">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 px-4">
        ...
        {playlistObra && (
          ...
          >
            <div className="absolute inset-0 bg-[url('/__l5e/assets-v1/036d36bd-ef2f-4640-b204-a71e6044a671/disco-casa-oracula.png')] opacity-5 bg-cover bg-center" />
            ...
            <div className="relative w-48 h-48 md:w-64 md:h-64 rounded-full overflow-hidden flex-shrink-0 border-2 border-emerald-500/20 group-hover:border-emerald-500/40 transition-colors">
              ...
              <img src="/__l5e/assets-v1/036d36bd-ef2f-4640-b204-a71e6044a671/disco-casa-oracula.png" className="w-full h-full object-cover relative z-10 opacity-60 group-hover:opacity-100 transition-opacity" alt="Playlist" />
