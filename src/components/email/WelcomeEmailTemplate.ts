/**
 * Welcome Email Template - Casa ORÁCULA
 * 
 * Mensagem automática enviada após cadastro
...
export function generateWelcomeEmailHtml({ 
  ...
  waitingListUrl = 'https://casaoracula.lovable.app/lista-espera'
        ...
        <table role="presentation" style="width: 100%; max-width: 520px; border-collapse: collapse;">
          ...
          <tr>
            <td align="center" style="padding-bottom: 32px;">
              <div style="width: 64px; height: 64px; border-radius: 50%; background: linear-gradient(135deg, rgba(212, 175, 55, 0.2), rgba(212, 175, 55, 0.1)); display: flex; align-items: center; justify-content: center;">
...
export function generateWelcomeEmailText({ userName }: WelcomeEmailProps): string {
  const firstName = userName?.split(' ')[0] || 'Você';
