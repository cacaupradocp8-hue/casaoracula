...
import { AtelieInstitucionalInput } from "@/hooks/useAtelieInstitucional";
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Gerador Institucional — Portais, Aulas e Missões
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            {generatedContent ? (
              <AtelieResultado
                ...
                institucional={generatedContent.institucional}
                onSaved={handleSaved}
              />
            ) : (
              <AtelieHistorico />
