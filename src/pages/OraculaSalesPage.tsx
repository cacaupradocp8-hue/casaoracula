 ...
 * Layout: Fundo preto puro, luxo ritualístico, cinematográfico
 */
  ...
  return (
    <div className="min-h-screen bg-black text-foreground overflow-x-hidden selection:bg-gold/20">
      ...
      <section className="py-16 px-6">
        ...
        >
          <div className="relative aspect-video rounded-2xl overflow-hidden border border-gold/15 shadow-[0_0_60px_-20px_hsl(var(--gold)/0.1)] bg-white/[0.03]">
            <iframe
              src=""
      ...
      <section className="relative py-16 md:py-20 px-6">
        ...
        >
          ...
          <h1 className="font-display text-3xl md:text-5xl lg:text-6xl text-white tracking-wide leading-[1.2] mb-8">
      ...
      <section className="py-16 px-6">
        ...
        >
          <div className="border border-gold/15 rounded-2xl p-10 md:p-14 bg-white/[0.02]">
            <h2 className="font-display text-2xl md:text-4xl text-white mb-10 text-center leading-snug">
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-10">
              {["sensibilidade", "intuição", "símbolos", "histórias"].map((item) => (
                <span key={item} className="px-4 py-2 rounded-full border border-gold/20 text-white/70 text-sm">
                  {item}
                </span>
              ))}
            </div>
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-14">
            {[
              ...
              <div
                key={item.label}
                className="border border-white/10 rounded-xl p-8 text-center hover:border-gold/20 transition-colors duration-500"
              >
          ...
          {/* Card principal */}
          <div className="border border-gold/20 rounded-2xl p-10 md:p-14 bg-white/[0.02] shadow-[0_0_60px_-20px_hsl(var(--gold)/0.08)]">
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            {[
              ...
              <div
                key={level.name}
                className="border border-white/10 rounded-xl p-6 text-center hover:border-gold/20 transition-all duration-500 group"
              >
          ...
          <div className="mt-12 text-center">
            ...
            <div className="flex justify-center gap-6 text-white/50 text-sm mb-6">
              <span>prática</span>
              <span>evidência</span>
              <span>revisão</span>
            </div>
      ...
      <section className="py-20 px-6">
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="border border-gold/15 rounded-2xl p-10 bg-white/[0.02] hover:shadow-[0_0_40px_-15px_hsl(var(--gold)/0.08)] transition-shadow duration-700">
          ...
          <div className="space-y-6">
            {[
              ...
              <motion.div
                ...
                className="flex gap-6 items-start border border-white/10 rounded-xl p-6 hover:border-gold/20 transition-colors duration-500"
              >
        ...
        >
          ...
          <div className="grid sm:grid-cols-2 gap-4 max-w-xl mx-auto mb-12">
            {[
              ...
              <div key={item} className="border border-white/10 rounded-lg p-4 text-white/50 text-sm">
                {item}
              </div>
            ))}
          </div>
        ...
        >
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
            {[
              ...
              <div
                key={tool}
                className="border border-white/10 rounded-xl p-6 text-center hover:border-gold/20 transition-colors duration-500"
              >
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-14 items-center">
          ...
          >
            ...
            <ul className="space-y-3 text-white/50 mb-8">
              {[
          ...
          >
            <img 
              ...
              className="rounded-2xl shadow-[0_0_60px_-20px_hsl(var(--gold)/0.15)] w-full object-cover border border-white/10"
            />
          </motion.div>
        </div>
      </section>
      ...
      <section className="relative py-20 px-6 overflow-hidden">
        ...
        >
          <div className="grid md:grid-cols-2 gap-10">
            <div className="border border-gold/15 rounded-2xl p-10 bg-white/[0.02]">
            ...
            <div className="border border-white/10 rounded-2xl p-10">
              <h2 className="font-display text-2xl text-white/30 mb-8">Para quem não é</h2>
        ...
        >
          ...
          <div className="space-y-4">
            {[
              ...
              <div
                key={item}
                className="flex items-center gap-4 border border-white/10 rounded-xl px-6 py-4 hover:border-gold/20 transition-colors duration-300"
              >
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button 
              ...
              className="border-white/20 hover:border-gold/30 text-white/70 hover:text-white"
            >
              Entrar
            </Button>
            <Button 
              ...
              className="bg-gold text-black hover:bg-gold/90 shadow-[0_0_30px_-8px_hsl(var(--gold)/0.3)]"
            >
              Ver Planos
