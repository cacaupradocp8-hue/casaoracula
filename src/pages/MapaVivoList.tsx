...
import { Plus, Search, Trash2, Map, Calendar } from 'lucide-react';
    ...
    <AppLayout>
      <div className="container max-w-5xl py-8 space-y-6">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            <h1 className="text-3xl font-display text-foreground">Mapa Vivo</h1>
            <p className="text-muted-foreground mt-1">
              Organize suas ideias de forma visual e simbólica
            </p>
          </div>
              ...
              >
                ...
                <CardContent>
                  <div className="flex items-center gap-2 text-sm text-muted-foreground">
                    ...
                    {format(new Date(map.updated_at), "d 'de' MMM, HH:mm", { locale: ptBR })}
                  </div>
                </CardContent>
              </Card>
            ))}
