      ...
      <div className="min-h-[100dvh] relative flex items-center justify-center p-4">
        ...
        <div className="relative z-10 w-full max-w-md">
          ...
          <div className="text-center mb-8">
            <Logo size="xl" variant="vertical" className="justify-center mb-4 scale-125 md:scale-150" />
          ...
          <GlassContainer>
            <Tabs defaultValue="login" className="w-full">
              ...
              <TabsContent value="login" className="mt-0">
                ...
                >
                  <motion.div variants={{ hidden: { y: 10, opacity: 0 }, visible: { y: 0, opacity: 1 } }} className="space-y-4">
              ...
              <TabsContent value="signup" className="mt-0">
                ...
                >
                  ...
                  <motion.p variants={{ hidden: { opacity: 0 }, visible: { opacity: 1 } }} className="text-[10px] text-muted-foreground/50 text-center px-4 leading-relaxed">
                    Ao criar conta, você inicia como <span className="text-gold/60">Visitante</span>.
                  </motion.p>
                </motion.form>
              </TabsContent>
            </Tabs>
