        ...
        >
          <GlassContainer>
            <Tabs defaultValue="login" className="w-full">
              <TabsList className="grid w-full grid-cols-2 mb-6 bg-background/40">
              ...
              <TabsContent value="login">
                <form onSubmit={handleLogin} className="space-y-4">
                  ...
                  <button type="button" onClick={() => setShowForgotPassword(true)} className="w-full text-xs text-muted-foreground hover:text-gold transition-colors text-center pt-1">
                    Esqueci minha senha
                  </button>
                </form>
              </TabsContent>
