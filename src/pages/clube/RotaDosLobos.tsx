      ...
      <div className="bg-[#020617] text-white min-h-screen overflow-x-hidden font-sans selection:bg-gold/30 selection:text-white">
        <div className="max-w-7xl mx-auto px-4 py-6 md:py-10 space-y-12 pb-20">
          ...
          <div className="space-y-10 pt-4 pb-32">
            ...
            <div className="flex flex-nowrap md:flex-wrap items-start justify-start md:justify-between gap-3 md:gap-6 overflow-x-auto pb-8 scrollbar-hide">
              {displayEstacoes.map((estacao, i) => {
                ...
                return (
                  <motion.div
                    ...
                    className="flex flex-col items-center gap-1.5 md:gap-3 min-w-[58px] md:min-w-[130px] group"
                  >
                    <button
                      disabled={isLocked}
                      onClick={() => !isLocked && navigate(`/clube/rota/${slug}`)}
                      className={cn(
                        "relative w-11 h-11 md:w-24 md:h-24 rounded-full flex items-center justify-center transition-all duration-700",
                        isActive 
                    ...
                    >
                      <div className={cn(
                        "absolute -top-1 -left-1 w-3.5 h-3.5 md:w-6 md:h-6 rounded-full flex items-center justify-center text-[6px] md:text-[10px] font-bold z-30 shadow-lg",
                      ...
                      {isActive ? (
                        <div className="relative z-20">
                          <TreePine className="w-5 h-5 md:w-8 md:h-8 text-gold" />
                          <div className="absolute inset-0 bg-gold/20 blur-lg rounded-full" />
                        </div>
                      ) : (
                        <Lock className={cn("w-3.5 h-3.5 md:w-5 md:h-5 z-20", isLocked ? "text-white/20" : "text-gold/40")} />
                      )}
                    ...
                    <span className={cn(
                      "text-[7px] md:text-[10px] text-center max-w-[58px] md:max-w-[100px] leading-tight font-medium uppercase tracking-[0.03em]",
