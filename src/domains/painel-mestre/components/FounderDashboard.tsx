...
import { FounderFinancialMetrics } from '../types';
...
export default function FounderDashboard() {
  ...
  const projectedRevenue = metrics.total_revenue + (projectionSettings.newUsers * 9700);
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="h-2 bg-emerald-500/10 rounded-full overflow-hidden">
                  <div className="h-full bg-emerald-500 transition-all duration-1000" style={{ width: `${Math.min(100, Math.max(0, metrics.net_margin_pct))}%` }} />
                </div>
              </div>
              <div className="space-y-2">
                <div className="flex justify-between text-sm font-medium">
                ...
                <div className="h-2 bg-primary/10 rounded-full overflow-hidden">
                  <div className="h-full bg-primary transition-all duration-1000" style={{ width: `${Math.min(100, metrics.ia_revenue_pct)}%` }} />
                </div>
              </div>
            </div>
