...
const SalaTreinamentoPage = React.lazy(() => import('@/pages/casa-maquinas/LaboratorioClinicoPage'));
...
const CasoDemonstrativoPage = React.lazy(() => import('@/pages/casa-maquinas/atlas/CasoDemonstrativoPage'));
