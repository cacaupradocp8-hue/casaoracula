...
export function renderClubeRoutes(ProtectedRoute: PR) {
  return (
    <>
      ...
      <Route key="clube-estacao" path="/clube/estacao/:id" element={<ProtectedRoute minPortal="mentorada"><StationDetail /></ProtectedRoute>} />

      <Route key="clube-rotas-catalogo" path="/clube/rotas" element={<ProtectedRoute minPortal="mentorada"><ClubeRotasCatalogo /></ProtectedRoute>} />
      ...
      <Route key="clube-lab-new" path="/clube/laboratorio" element={<ProtectedRoute minPortal="mentorada"><ClubeLaboratorio /></ProtectedRoute>} />
      ...
      <Route key="cl-lab-legacy" path="/clube-livro/:id/lab-8020" element={<Navigate to="/clube" replace />} />
