        ...
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('session_interventions_session_id_fkey', 'TYPE_MISMATCH', 'session_interventions', 'session_id', 'sessions', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('session_oracle_draws_case_id_fkey', 'TYPE_MISMATCH', 'session_oracle_draws', 'case_id', 'session_cases', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('session_oracle_draws_client_id_fkey', 'TYPE_MISMATCH', 'session_oracle_draws', 'client_id', 'profiles', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('session_oracle_draws_therapist_id_fkey', 'TYPE_MISMATCH', 'session_oracle_draws', 'therapist_id', 'profiles', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('session_scripts_case_id_fkey', 'TYPE_MISMATCH', 'session_scripts', 'case_id', 'session_cases', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('session_scripts_client_id_fkey', 'TYPE_MISMATCH', 'session_scripts', 'client_id', 'profiles', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('session_scripts_narrative_map_id_fkey', 'TYPE_MISMATCH', 'session_scripts', 'narrative_map_id', 'narrative_maps', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('session_scripts_therapist_id_fkey', 'TYPE_MISMATCH', 'session_scripts', 'therapist_id', 'profiles', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('sessions_cidadela_card_id_fkey', 'TYPE_MISMATCH', 'sessions', 'cidadela_card_id', 'cidadela_oracle_cards', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('sessions_client_id_fkey', 'TYPE_MISMATCH', 'sessions', 'client_id', 'clientes', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('sessions_district_id_fkey', 'TYPE_MISMATCH', 'sessions', 'district_id', 'districts', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('sessions_tool_id_fkey', 'TYPE_MISMATCH', 'sessions', 'tool_id', 'tools', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('sessoes_casa_maquinas_cliente_id_fkey', 'TYPE_MISMATCH', 'sessoes_casa_maquinas', 'cliente_id', 'clientes', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('sessoes_labirinto_porta_id_fkey', 'TYPE_MISMATCH', 'sessoes_labirinto', 'porta_id', 'labirinto_fases', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('simulador_progresso_cenario_id_fkey', 'TYPE_MISMATCH', 'simulador_progresso', 'cenario_id', 'simulador_cenarios', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('sonho_estruturado_cliente_id_fkey', 'TYPE_MISMATCH', 'sonho_estruturado', 'cliente_id', 'clientes', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('sonhos_cabalisticos_client_id_fkey', 'TYPE_MISMATCH', 'sonhos_cabalisticos', 'client_id', 'clientes', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('station_progress_station_id_fkey', 'TYPE_MISMATCH', 'station_progress', 'station_id', 'clube_estacoes', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('studio_episodes_eixo_id_fkey', 'TYPE_MISMATCH', 'studio_episodes', 'eixo_id', 'studio_method_axes', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('symbolic_template_sessions_case_id_fkey', 'TYPE_MISMATCH', 'symbolic_template_sessions', 'case_id', 'session_cases', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('symbolic_template_sessions_cliente_id_fkey', 'TYPE_MISMATCH', 'symbolic_template_sessions', 'cliente_id', 'clientes', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('syntheia_conversations_mode_id_fkey', 'TYPE_MISMATCH', 'syntheia_conversations', 'mode_id', 'syntheia_modes', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('syntheia_conversations_voice_id_fkey', 'TYPE_MISMATCH', 'syntheia_conversations', 'voice_id', 'syntheia_voices', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('syntheia_messages_conversation_id_fkey', 'TYPE_MISMATCH', 'syntheia_messages', 'conversation_id', 'syntheia_conversations', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('tecela_conselho_respostas_conselho_id_fkey', 'TYPE_MISMATCH', 'tecela_conselho_respostas', 'conselho_id', 'tecela_conselho', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('tecela_ressonancias_registro_id_fkey', 'TYPE_MISMATCH', 'tecela_ressonancias', 'registro_id', 'tecela_registros_campo', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('tecela_supervisoes_caso_id_fkey', 'TYPE_MISMATCH', 'tecela_supervisoes', 'caso_id', 'tecela_casos_espelho', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('tool_districts_district_id_fkey', 'TYPE_MISMATCH', 'tool_districts', 'district_id', 'city_districts', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('tool_districts_tool_id_fkey', 'TYPE_MISMATCH', 'tool_districts', 'tool_id', 'tools', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('tools_district_id_fkey', 'TYPE_MISMATCH', 'tools', 'district_id', 'districts', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('tools_ferramenta_pai_id_fkey', 'TYPE_MISMATCH', 'tools', 'ferramenta_pai_id', 'tools', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('tools_proximo_passo_id_fkey', 'TYPE_MISMATCH', 'tools', 'proximo_passo_id', 'tools', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('torre_arquetipo_sugestao_arquetipo_id_fkey', 'TYPE_MISMATCH', 'torre_arquetipo_sugestao', 'arquetipo_id', 'atlas_arquetipos_femininos', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('torre_porta_relacao_porta_id_fkey', 'TYPE_MISMATCH', 'torre_porta_relacao', 'porta_id', 'labirinto_portas', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('towers_client_id_fkey', 'TYPE_MISMATCH', 'towers', 'client_id', 'clientes', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('towers_session_id_fkey', 'TYPE_MISMATCH', 'towers', 'session_id', 'sessions', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('travessia_comentarios_user_id_fkey', 'TYPE_MISMATCH', 'travessia_comentarios', 'user_id', 'profiles', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('travessia_day_unlocks_aula_id_fkey', 'TYPE_MISMATCH', 'travessia_day_unlocks', 'aula_id', 'conteudo_aulas', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('travessia_library_items_familia_id_fkey', 'TYPE_MISMATCH', 'travessia_library_items', 'familia_id', 'travessia_familias', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('travessia_library_media_item_id_fkey', 'TYPE_MISMATCH', 'travessia_library_media', 'item_id', 'travessia_library_items', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('travessia_library_tags_item_id_fkey', 'TYPE_MISMATCH', 'travessia_library_tags', 'item_id', 'travessia_library_items', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('treinamento_respostas_caso_id_fkey', 'TYPE_MISMATCH', 'treinamento_respostas', 'caso_id', 'treinamento_casos_simulados', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('upsell_opportunities_rule_id_fkey', 'TYPE_MISMATCH', 'upsell_opportunities', 'rule_id', 'upsell_rules', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('user_aula_progress_aula_id_fkey', 'TYPE_MISMATCH', 'user_aula_progress', 'aula_id', 'conteudo_aulas', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('user_cidadela_estado_user_id_fkey', 'TYPE_MISMATCH', 'user_cidadela_estado', 'user_id', 'profiles', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('user_favorites_library_item_id_fkey', 'TYPE_MISMATCH', 'user_favorites', 'library_item_id', 'library_items', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('user_progress_lesson_id_fkey', 'TYPE_MISMATCH', 'user_progress', 'lesson_id', 'lessons', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('user_unlocked_rewards_reward_id_fkey', 'TYPE_MISMATCH', 'user_unlocked_rewards', 'reward_id', 'symbolic_rewards', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
