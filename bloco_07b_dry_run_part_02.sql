        ...
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('client_cidadela_map_client_id_fkey', 'TYPE_MISMATCH', 'client_cidadela_map', 'client_id', 'clientes', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('client_city_state_arquetipo_ativo_fkey', 'TYPE_MISMATCH', 'client_city_state', 'arquetipo_ativo', 'founding_archetypes', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('client_city_state_client_id_fkey', 'TYPE_MISMATCH', 'client_city_state', 'client_id', 'clientes', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('client_city_state_distrito_id_fkey', 'TYPE_MISMATCH', 'client_city_state', 'distrito_id', 'city_districts', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('client_city_state_ultima_ferramenta_id_fkey', 'TYPE_MISMATCH', 'client_city_state', 'ultima_ferramenta_id', 'tools', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('client_city_state_ultima_sessao_id_fkey', 'TYPE_MISMATCH', 'client_city_state', 'ultima_sessao_id', 'sessions', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('client_labyrinths_client_id_fkey', 'TYPE_MISMATCH', 'client_labyrinths', 'client_id', 'clientes', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('client_live_map_entries_session_id_fkey', 'TYPE_MISMATCH', 'client_live_map_entries', 'session_id', 'sessions', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('client_pattern_stats_client_id_fkey', 'TYPE_MISMATCH', 'client_pattern_stats', 'client_id', 'clientes', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('client_seasons_client_id_fkey', 'TYPE_MISMATCH', 'client_seasons', 'client_id', 'clientes', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('club_books_cycle_id_fkey', 'TYPE_MISMATCH', '_deprecated_club_books', 'cycle_id', '_deprecated_club_cycles', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('club_knowledge_entries_book_id_fkey', 'TYPE_MISMATCH', '_deprecated_club_knowledge_entries', 'book_id', 'books', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('club_meetings_cycle_id_fkey', 'TYPE_MISMATCH', '_deprecated_club_meetings', 'cycle_id', '_deprecated_club_cycles', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('club_user_cycles_cycle_id_fkey', 'TYPE_MISMATCH', '_deprecated_club_user_cycles', 'cycle_id', '_deprecated_club_cycles', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('clube_audio_albums_estacao_id_fkey', 'TYPE_MISMATCH', 'clube_audio_albums', 'estacao_id', 'clube_estacoes', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('clube_audio_progress_track_id_fkey', 'TYPE_MISMATCH', 'clube_audio_progress', 'track_id', 'clube_audio_tracks', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('clube_audio_tracks_album_id_fkey', 'TYPE_MISMATCH', 'clube_audio_tracks', 'album_id', 'clube_audio_albums', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('clube_carrossel_slides_estacao_id_fkey', 'TYPE_MISMATCH', 'clube_carrossel_slides', 'estacao_id', 'oracular_seasons', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('clube_engajamento_estacao_id_fkey', 'TYPE_MISMATCH', 'clube_engajamento', 'estacao_id', 'clube_estacoes', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('clube_estacao_registros_estacao_id_fkey', 'TYPE_MISMATCH', 'clube_estacao_registros', 'estacao_id', 'clube_estacoes', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('clube_estacoes_cartografia_id_fkey', 'TYPE_MISMATCH', 'clube_estacoes', 'cartografia_id', 'cartographies', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('clube_estacoes_quiz_id_fkey', 'TYPE_MISMATCH', 'clube_estacoes', 'quiz_id', 'quizzes', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('clube_jornadas_estacao_id_fkey', 'TYPE_MISMATCH', 'clube_jornadas', 'estacao_id', 'clube_estacoes', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('clube_livro_aulas_porta_id_fkey', 'TYPE_MISMATCH', 'clube_livro_aulas', 'porta_id', 'clube_livro_portas', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('clube_livro_chat_interactions_book_id_fkey', 'TYPE_MISMATCH', 'clube_livro_chat_interactions', 'book_id', 'books', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('clube_livro_encontros_estacao_id_fkey', 'TYPE_MISMATCH', 'clube_livro_encontros', 'estacao_id', 'clube_estacoes', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('clube_livro_respostas_pergunta_id_fkey', 'TYPE_MISMATCH', 'clube_livro_respostas', 'pergunta_id', 'clube_livro_perguntas', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('clube_obras_essencia_8020_book_id_fkey', 'TYPE_MISMATCH', 'clube_obras_essencia_8020', 'book_id', 'books', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('clube_portais_jornada_id_fkey', 'TYPE_MISMATCH', 'clube_portais', 'jornada_id', 'clube_jornadas', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('clube_portal_audios_portal_id_fkey', 'TYPE_MISMATCH', 'clube_portal_audios', 'portal_id', 'clube_portais', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('clube_portal_insights_estacao_id_fkey', 'TYPE_MISMATCH', 'clube_portal_insights', 'estacao_id', 'oracular_seasons', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('clube_portal_materiais_portal_id_fkey', 'TYPE_MISMATCH', 'clube_portal_materiais', 'portal_id', 'clube_portais', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('clube_progresso_passos_passo_id_fkey', 'TYPE_MISMATCH', 'clube_progresso_passos', 'passo_id', 'clube_rota_itens', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('clube_reflexoes_estacao_id_fkey', 'TYPE_MISMATCH', 'clube_reflexoes', 'estacao_id', 'clube_estacoes', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('clube_rota_itens_estacao_id_fkey', 'TYPE_MISMATCH', 'clube_rota_itens', 'estacao_id', 'clube_estacoes', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('clube_rota_progresso_estacao_id_fkey', 'TYPE_MISMATCH', 'clube_rota_progresso', 'estacao_id', 'clube_estacoes', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('clube_rota_progresso_rota_item_id_fkey', 'TYPE_MISMATCH', 'clube_rota_progresso', 'rota_item_id', 'clube_rota_itens', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('clube_v3_station_audios_station_id_fkey', 'TYPE_MISMATCH', 'clube_v3_station_audios', 'station_id', 'clube_v3_stations', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('clube_v3_station_content_station_id_fkey', 'TYPE_MISMATCH', 'clube_v3_station_content', 'station_id', 'clube_v3_stations', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('clube_v3_stations_route_id_fkey', 'TYPE_MISMATCH', 'clube_v3_stations', 'route_id', 'clube_v3_routes', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('clube_v3_user_progress_station_id_fkey', 'TYPE_MISMATCH', 'clube_v3_user_progress', 'station_id', 'clube_v3_stations', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('co_ai_recommendations_client_id_fkey', 'TYPE_MISMATCH', 'co_ai_recommendations', 'client_id', 'clientes', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('co_ai_recommendations_tool_complementar_id_fkey', 'TYPE_MISMATCH', 'co_ai_recommendations', 'tool_complementar_id', 'sala_ferramentas', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('co_ai_recommendations_tool_sugerida_id_fkey', 'TYPE_MISMATCH', 'co_ai_recommendations', 'tool_sugerida_id', 'sala_ferramentas', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('co_appointments_client_id_fkey', 'TYPE_MISMATCH', 'co_appointments', 'client_id', 'clientes', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('co_appointments_workspace_id_fkey', 'TYPE_MISMATCH', 'co_appointments', 'workspace_id', 'co_workspaces', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('co_camara_sussurro_casos_proximo_treino_id_fkey', 'TYPE_MISMATCH', 'co_camara_sussurro_casos', 'proximo_treino_id', 'co_camara_sussurro_casos', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
    ...
    ELSE
        IF 'public' = 'auth' THEN
            ...
            ELSE
                ...
                -- Check compatibility (uuid is common)
                IF v_source_type NOT IN ('uuid', 'text', 'character varying') THEN
                     INSERT INTO diagnostic_results VALUES ('co_city_history_client_id_fkey', 'TYPE_MISMATCH', 'co_city_history', 'client_id', 'clientes', 'id', 'Source type ' || v_source_type || ' might not match auth.users');
                ELSE
